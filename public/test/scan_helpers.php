...
// BASE PATH = project-root (public → project-root)
...
// Recursively scan PHP files under project-root
...
<body>
  ...
  <p>Document root (from PHP): <code><?= sh_h($_SERVER['DOCUMENT_ROOT'] ?? '') ?></code></p>
  <p>Current script: <code><?= sh_h(__FILE__) ?></code></p>
