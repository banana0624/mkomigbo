...
// View-level permission – readers + writers
...
$body_class  = 'role--staff role--contrib credits-show';
    ...
    <div class="mk-form">
      ...
      <dl class="mk-dl">
        <div class="mk-dl__row">
          <dt>Subject</dt>
          <dd><?= h((string)($row['subject'] ?? '')) ?></dd>
        </div>

        <div class="mk-dl__row">
          <dt>Points</dt>
          <dd><?= (int)($row['points'] ?? 0) ?></dd>
        </div>

        <div class="mk-dl__row mk-dl__row--block">
          <dt>Note</dt>
          <dd class="muted">
            <?= nl2br(h((string)($row['note'] ?? ''))) ?>
          </dd>
        </div>
      </dl>
      ...
      <div class="mk-form__actions">
        ...
        <a class="mk-btn-secondary"
           href="<?= h(url_for('/staff/contributors/credits/')) ?>">
          Back to Credits
        </a>
      </div>
    </div>
