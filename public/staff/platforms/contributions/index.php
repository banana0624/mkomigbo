<?php
// project-root/public/staff/platforms/contributions/index.php
...
$platform_slug = 'contributions';
$platform_name = 'Contributions';

$page_title = "Staff • {$platform_name}";
$active_nav = 'staff';
$body_class = 'role--staff platform--' . $platform_slug;
$page_logo  = '/lib/images/icons/hand-heart.svg'; // placeholder; swap if you have one
