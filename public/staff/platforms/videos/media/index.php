...
$uploadsDir = platform_uploads_dir($platform_slug); $uploadsUrl = platform_uploads_url($platform_slug);
$files = [];
...
$page_title="{$platform_name} • Media"; $active_nav='staff'; $body_class="role--staff platform--{$platform_slug}";
$page_logo="/lib/images/platforms/{$platform_slug}.svg"; $stylesheets[]='/lib/css/ui.css';
$breadcrumbs=[['label'=>'Home','url'=>'/'],['label'=>'Staff','url'=>'/staff/'],['label'=>'Platforms','url'=>'/staff/platforms/'],['label'=>$platform_name,'url'=>"/staff/platforms/{$platform_slug}/"],['label'=>'Media']];
