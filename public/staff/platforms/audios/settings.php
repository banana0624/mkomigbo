<?php
// project-root/public/staff/platforms/audios/settings.php
declare(strict_types=1);

// audios → platforms → staff → public → (↑4) project-root
...
<main class="container" style="max-width:720px;padding:1.25rem 0">
  ...
  <form method="post">
    ...
    <div class="field"><label>Default banner</label>
      <input class="input" type="text" name="banner" placeholder="/lib/images/banners/audios.jpg" value="<?= h($settings['banner'] ?? '') ?>">
    </div>
