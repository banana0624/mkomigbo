<?php
// project-root/public/staff/platforms/communities/index.php
declare(strict_types=1);

// communities → platforms → staff → public → (↑4) project-root
$init = dirname(__DIR__, 4) . '/private/assets/initialize.php';
if (!is_file($init)) { die('Init not found at: ' . $init); }
require_once $init;

$platform_slug = 'communities';
$platform_name = 'Communities';

$page_title = "Staff • {$platform_name}";
$active_nav = 'staff';
$body_class = 'role--staff platform--' . $platform_slug;
$page_logo  = '/lib/images/icons/users.svg'; // swap if you add a specific icon
