<?php
// project-root/public/staff/platforms/logs/settings.php
...
<main class="container" style="max-width:720px;padding:1.25rem 0">
  ...
  <form method="post">
    ...
    <div class="field"><label>Default banner</label>
      <input class="input" type="text" name="banner" placeholder="/lib/images/banners/logs.jpg" value="<?= h($settings['banner'] ?? '') ?>">
    </div>
    <div class="actions">
