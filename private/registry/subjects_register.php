...
$SUBJECTS_REGISTRY = [
  ...
  9  => ['id'=>9,  'name'=>'Language 1',   'slug'=>'language1',    'nav_order'=>9,  'meta_description'=>'Pages related to first language.', 'meta_keywords'=>'language, communication, dialect',       'icon'=>'/lib/images/subjects/language1.svg'],
  10 => ['id'=>10, 'name'=>'Language 2',   'slug'=>'language2',    'nav_order'=>10, 'meta_description'=>'Pages related to second language.','meta_keywords'=>'language, communication, dialect',       'icon'=>'/lib/images/subjects/language2.svg'],
  ...
  14 => ['id'=>14, 'name'=>'IPOB',         'slug'=>'ipob',         'nav_order'=>14, 'meta_description'=>'Pages related to IPOB.',           'meta_keywords'=>'ipob, biafra, movement, nigeria',        'icon'=>'/lib/images/subjects/ipob.svg'],
