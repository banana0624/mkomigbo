<?php
// subjects_header_language1.php
declare(strict_types=1);

$subject_slug = 'language1';
$page_title = $page_title ?? 'Language 1';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'language1, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/language1.css'); ?>">
<body class="subject-language1" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-language1">
