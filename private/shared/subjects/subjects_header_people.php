<?php
// subjects_header_people.php
declare(strict_types=1);

$subject_slug = 'people';
$page_title = $page_title ?? 'People';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'people, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/people.css'); ?>">
<body class="subject-people" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-people">
