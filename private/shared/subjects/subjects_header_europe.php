<?php
// subjects_header_europe.php
declare(strict_types=1);

$subject_slug = 'europe';
$page_title = $page_title ?? 'Europe';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'europe, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/europe.css'); ?>">
<body class="subject-europe" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-europe">
