<?php
// subjects_header_arabs.php
declare(strict_types=1);

$subject_slug = 'arabs';
$page_title = $page_title ?? 'Arabs';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'arabs, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/arabs.css'); ?>">
<body class="subject-arabs" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-arabs">
