<?php
// subjects_header_persons.php
declare(strict_types=1);

$subject_slug = 'persons';
$page_title = $page_title ?? 'Persons';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'persons, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/persons.css'); ?>">
<body class="subject-persons" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-persons">
