<?php
// subjects_header_language2.php
declare(strict_types=1);

$subject_slug = 'language2';
$page_title = $page_title ?? 'Language 2';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'language2, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/language2.css'); ?>">
<body class="subject-language2" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-language2">
