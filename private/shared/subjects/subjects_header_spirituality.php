<?php
// subjects_header_spirituality.php
declare(strict_types=1);

$subject_slug = 'spirituality';
$page_title = $page_title ?? 'Spirituality';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'spirituality, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/spirituality.css'); ?>">
<body class="subject-spirituality" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-spirituality">
