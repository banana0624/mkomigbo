<?php
// subjects_header_history.php
declare(strict_types=1);

$subject_slug = 'history';
$page_title = $page_title ?? 'History';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'history, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/history.css'); ?>">
<body class="subject-history" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-history">
