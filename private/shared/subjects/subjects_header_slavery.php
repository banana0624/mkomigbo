<?php
// subjects_header_slavery.php
declare(strict_types=1);

$subject_slug = 'slavery';
$page_title = $page_title ?? 'Slavery';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'slavery, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/slavery.css'); ?>">
<body class="subject-slavery" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-slavery">
