<?php
// subjects_header_africa.php
declare(strict_types=1);

$subject_slug = 'africa';
$page_title = $page_title ?? 'Africa';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'africa, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/africa.css'); ?>">
<body class="subject-africa" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-africa">
