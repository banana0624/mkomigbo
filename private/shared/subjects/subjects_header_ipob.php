<?php
// subjects_header_ipob.php
declare(strict_types=1);

$subject_slug = 'ipob';
$page_title = $page_title ?? 'IPOB';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'ipob, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/ipob.css'); ?>">
<body class="subject-ipob" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-ipob">
