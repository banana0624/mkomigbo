<?php
// subjects_header_uk.php
declare(strict_types=1);

$subject_slug = 'uk';
$page_title = $page_title ?? 'UK';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'uk, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/uk.css'); ?>">
<body class="subject-uk" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-uk">
