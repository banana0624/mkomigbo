<?php
// subjects_header_about.php
declare(strict_types=1);

$subject_slug = 'about';
$page_title = $page_title ?? 'About';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'about, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/about.css'); ?>">
<body class="subject-about" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-about">
