<?php
// subjects_header_biafra.php
declare(strict_types=1);

$subject_slug = 'biafra';
$page_title = $page_title ?? 'Biafra';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'biafra, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/biafra.css'); ?>">
<body class="subject-biafra" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-biafra">
