<?php
// subjects_header_tradition.php
declare(strict_types=1);

$subject_slug = 'tradition';
$page_title = $page_title ?? 'Tradition';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'tradition, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/tradition.css'); ?>">
<body class="subject-tradition" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-tradition">
