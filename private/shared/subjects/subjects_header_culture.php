<?php
// subjects_header_culture.php
declare(strict_types=1);

$subject_slug = 'culture';
$page_title = $page_title ?? 'Culture';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'culture, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/culture.css'); ?>">
<body class="subject-culture" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-culture">
