<?php
// subjects_header_struggles.php
declare(strict_types=1);

$subject_slug = 'struggles';
$page_title = $page_title ?? 'Struggles';
$page_description = $page_description ?? '';
$page_keywords = $page_keywords ?? 'struggles, mkomigbo';
...
<link rel="stylesheet" href="<?php echo url_for('/lib/css/subjects/struggles.css'); ?>">
<body class="subject-struggles" data-theme="<?php echo h($current_theme ?? 'light'); ?>">

<header class="site-header layout-subjects subject-struggles">
